...
# Use specific paths for data files
excel_path = '/Users/dameesh/Desktop/MinMUDAC2025/Data/Novice.xlsx'
test_data_path = '/Users/dameesh/Desktop/MinMUDAC2025/Data/Test-Truncated-Restated-Consolidated.xlsx'
...
def main():
    ...
    # Check if we're processing test data
    process_test = len(sys.argv) > 1 and sys.argv[1] == 'test'
    
    if process_test:
        input_file = test_data_path
        output_file = os.path.join(script_dir, 'enhanced_test_data.xlsx')
        report_file_path = os.path.join(script_dir, 'test_data_cleaning_report.txt')
        print(f"Processing test data from: {input_file}")
    else:
        input_file = excel_path
        output_file = ENHANCED_DATA_PATH
        report_file_path = REPORT_PATH
        print(f"Processing training data from: {input_file}")
    ...
    with open(report_file_path, 'w') as report_file:
        ...
        # Read the Excel file using the specific path
        print(f"Reading dataset: {input_file}")
        report_file.write(f"Reading dataset: {input_file}\n")
    ...
    print("\nFiles saved:")
    print(f"- Comprehensive data cleaning report: {report_file_path}")
